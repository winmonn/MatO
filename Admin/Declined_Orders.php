...
$query_declined_count = "
    SELECT COUNT(*) AS declined_count
    FROM orderitems
    WHERE ostatus = 'Declined'
";

$result_declined_count = $conn->query($query_declined_count);
$declined_count = $result_declined_count->fetch_assoc()['declined_count'];
...
<div class="header-nav">
     ...
     <div class="dashboard">
        <div class="card">
            <div class="text">
                <p style="font-size: 1.5em; font-weight: bold;"><?php echo $declined_count ?></p>
                <p style="font-size: 1.5em;">Declined Orders</p>
            </div>
            <div class="user-icon">
                <a href="Orders.php">
    ...
    <table>
            ...
            <?php
            if ($result_declined_orders->num_rows > 0) {
                while($row = $result_declined_orders->fetch_assoc()) {
                    echo "<tr>";
                ...
                echo "<tr><td colspan='6'>No declined orders found</td></tr>";
            }
            ?>
        </table>
    </div>
