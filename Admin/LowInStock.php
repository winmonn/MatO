...
$query_products = "
    ...
    FROM products
    WHERE Quantity > 0 AND Quantity < 250
";
     ...
     <div class="dashboard">
        <div class="card">
            <div class="text">
                ...
                <p style="font-size: 1.5em;">Products Low In Stock</p>
            </div>
            <div class="user-icon">
                <a href="Products.php">
    ...
    <div class="tformat">
        ...
        <table>
            ...
            if ($result_products->num_rows > 0) {
                ...
                echo "<tr><td colspan='4'>No products found in stock</td></tr>";
            }
            ?>
        </table>
    </div>
