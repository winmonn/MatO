    ...
    $query_completed = "SELECT COUNT(*) AS completed_count FROM orderitems WHERE ostatus = 'completed'";
    ...
    <body>
        ...
        <div class="card">
            <div class="text">
                <p style="font-size: 1.5em; font-weight: bold;"><?php echo $completed_count ?></p>
                <p style="font-size: 1.5em;">Completed Orders</p>
            </div>
            <div class="user-icon">
                <a href="Orders.php">
