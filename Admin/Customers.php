...
$query_customers = "SELECT CustomerID, FirstName, LastName, Email, PhoneNumber, Username, Password, date_of_birth, current_location, profile_picture FROM customer";
...
<body>
    <div class="header-nav">
     ...
     <div class="dashboard">
        <div class="card">
            <div class="text">
                <p style="font-size: 1.5em; font-weight: bold;"><?php echo $user_counts['customer_count']; ?></p>
                <p style="font-size: 1.5em;">Customers</p>
            </div>
            <div class="user-icon">
